...
|RF-014| Permitir que o usuário consiga suporte via chat   | Lucas Warley | |
...
|RNF-003| A aplicação deve enviar ao usuário email de confirmação de cadastro | A definir | registro.html|
...
|RNF-007| A Aplicação precisa comunicar-se com API para oferecer suporte via chat aos usuários   | A definir  | |
